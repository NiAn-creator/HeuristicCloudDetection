...
class mResNet50_PHA_DBRM(nn.Module):
    def __init__(self, num_classes=2):
        super(mResNet50_PHA_DBRM, self).__init__()

        backbone = mresnet.resnet50(pretrained=True)
        ...
        self.bd_extract1 = nn.Sequential(DeformConv2d(64, 64, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(64),
                                         nn.ReLU(inplace=True),
                                         ...
                                         nn.BatchNorm2d(64),
                                         nn.ReLU(inplace=True))
        self.bd_extract2 = nn.Sequential(DeformConv2d(256, 256, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(256),
                                         nn.ReLU(inplace=True),
                                         DeformConv2d(256, 256, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(256),
                                         nn.ReLU(inplace=True),
                                         DeformConv2d(256, 256, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(256),
                                         nn.ReLU(inplace=True))
        self.bd_extract3 = nn.Sequential(DeformConv2d(512, 512, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(512),
                                         nn.ReLU(inplace=True),
                                         DeformConv2d(512, 512, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(512),
                                         nn.ReLU(inplace=True),
                                         DeformConv2d(512, 512, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(512),
        ...
        self.score_dsn1 = DeformConv2d(128, 1, kernel_size=1)
        self.score_dsn2 = DeformConv2d(512, 1, kernel_size=1)
        self.score_dsn3 = DeformConv2d(1024, 1, kernel_size=1)
