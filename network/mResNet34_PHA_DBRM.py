...
class mResNet34_PHA_DBRM(nn.Module):
    def __init__(self, num_classes=2):
        super(mResNet34_PHA_DBRM, self).__init__()
        ...
        self.bd_extract1 = nn.Sequential(DeformConv2d(64, 128, kernel_size=3, padding=1),
                                         ...
                                         nn.BatchNorm2d(64),
                                         nn.ReLU(inplace=True))
        self.bd_extract2 = nn.Sequential(DeformConv2d(64, 128, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(128),
                                         nn.ReLU(inplace=True),
                                         DeformConv2d(128, 128, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(128),
                                         ...
                                         nn.BatchNorm2d(64),
                                         nn.ReLU(inplace=True))
        self.bd_extract3 = nn.Sequential(DeformConv2d(128, 128, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(128),
                                         nn.ReLU(inplace=True),
                                         DeformConv2d(128, 128, kernel_size=3, padding=1),
                                         nn.BatchNorm2d(128),
        ...
        self.score_dsn1 = DeformConv2d(128, 128, kernel_size=1)
        self.score_dsn2 = DeformConv2d(128, 128, kernel_size=1)
        self.score_dsn3 = DeformConv2d(256, 256, kernel_size=1)
